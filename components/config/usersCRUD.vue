<template>
  <v-container>
    ...
    <!-- Dialog para edita y crear un usuario -->
    ...
    <!-- Termina dialog par editar y crear -->
    ...
    <v-dialog v-model="confirmDialog" persistent max-width="400px">
      <v-card color="indigo lighten-5">
        ...
        <v-card-actions>
          ...
          <v-btn color="red" :disable="!selectedUser" @click="deleteUser(selectedUser)">
            Borrar
          </v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
    <!--Termina dialogo para confirmar borrado-->
  </v-container>
</template>
    ...
    async deleteUser () {
      try {
        ...
        this.$store.dispatch('alert/triggerAlert', {
          massage: 'Usuario borrado satisfactoriamente',
          type: 'success'
        })
        this.loadUsers()
